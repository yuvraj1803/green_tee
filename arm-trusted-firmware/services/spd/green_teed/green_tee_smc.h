...
#define GREEN_TEE_SMC_ENTRY_DONE	(ARM_SMCCC_FAST_CALL_MASK | ARM_SMCCC_SMC64_MASK | ((50 << ARM_SMCCC_OWNER_SHIFT) & ARM_SMCCC_OWNER_MASK) | (0 & ARM_SMCCC_FUNCTION_NR_MASK))
